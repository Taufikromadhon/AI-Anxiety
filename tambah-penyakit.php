                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="tambah-penyakit.php">Tambah Daftar Penyakit</a></li>
                                </ul>
                            </li>
                            <li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h3 class="page-title pull-left">Tambah Jenis Penyakit</h3>
              ...
              <div class="container" style="max-width: 80%;">
                 <!-- basic form start -->
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <form action="tambah-penyakit-proses.php" method="POST">
                                            <div class="login-form-head">
                                                <h4>Tambah Jenis Penyakit</h4>
                                                <p>Isikan form berikut untuk menambahkan jenis penyakit.</p><br>
                                            <div style="text-align: left;">
                                                ...
                                                <p>
                                                    ...
                                                    3. ID Penyakit berada di range M1-M3 dan K1-K4.<br>
                                            ...
                                            <div class="form-group">
                                                <label for="username">Id Penyakit</label>
                                                <input type="text" class="form-control" placeholder="Masukan Id Penyakit" name="id-penyakit-baru" minlength="2" maxlength="3" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="namapakar">Nama Penyakit</label>
                                                <input type="text" class="form-control" name="penyakit-baru-nama-penyakit" minlength="1" maxlength="100" placeholder="Masukan Nama Penyakit" required >
                                            </div>
                                            <div class="form-group">
                                                <label for="username">Definisi Dan Solusi</label>
                                                <textarea class="ckeditor" id="ckedtor" name="penyakit-baru-definisi-solusi" required></textarea>
