                 ...
                 <form action="tambah-pakar-proses.php" method="POST">
                    ...
                    <div class="login-form-body">
                        <div class="form-gp">
                            ...
                            <input type="text" name="pakar-baru-username" minlength="1" maxlength="20" id="username" required>
                            <i class="ti-user"></i>
                        </div>
                        <div class="form-gp">
                            <label for="exampleInputPassword1">Password</label>
                            <input type="password" minlength="1" maxlength="10" name="pakar-baru-password" id="pass" required>
                            <i class="ti-lock"></i>
                        </div>
                        <div class="form-gp">
                            <label for="username">Nama Lengkap</label>
                            <input type="text" name="pakar-baru-nama-lengkap" minlength="1" maxlength="30" id="username" required>
                            <i class="ti-medall"></i>
                        </div>
                        <div class="form-gp">
                            <label for="exampleInputPassword1">Email</label>
                            <input type="mail" name="pakar-baru-email" minlength="1" maxlength="100" id="pass" required>
                            <i class="ti-email"></i>
                        </div>
