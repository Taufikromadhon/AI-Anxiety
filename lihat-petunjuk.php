    ...
    <div class="page-container">
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                              ...
                              <li class="active">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="lihat-petunjuk.php">Lihat Daftar Petunjuk</a></li>
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h3 class="page-title pull-left">Halaman Lihat Daftar Petunjuk</h3>
            ...
            <div class="container" style="max-width: 80%;">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <h4>Daftar Petunjuk AI Anxiety</h4>    
                                    </div>
                                    <div class="col-sm-6 text-right" style="align-content: right;" >
                                        <a href="tambah-petunjuk.php">+ Tambah Petunjuk</a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table class="table table-hover progress-table text-center">
                                            ...
                                            <thead class="text-uppercase">
                                                <tr>
                                                    ...
                                                    <th scope="col">ID Petunjuk</th>
                                                    <th scope="col">Isi Petunjuk</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <?php $no++; ?>
                                                    <td><?php echo $data['id_petunjuk']; ?></td>
                                                    <td><?php echo $data['isi_petunjuk']; ?></td> 
                                                    
                                                        <td>
                                                        <ul class="d-flex justify-content-center">
                                                            <li class="mr-3">
                                                                <a href="#" class="open_modal" id='<?php echo  $data['id_petunjuk'];?>' data-toggle="modal" data-target="#myModal<?php echo $data['id_petunjuk']; ?>"
                                                                ><i class="fa fa-edit"></i></a></li>
                                                            
                                                            <li><a href="delete-data-petunjuk.php?id=<?php echo $data['id_petunjuk']; ?>" onclick="return confirm('Yakin Hapus?')" class="text-danger"><i class="ti-trash"></i></a></li>
                                                        </ul>
                                                        </td>
                    ...
                    <?php 
                        $query = mysqli_query($con, "SELECT * FROM petunjuk");
                        $no = 1;
                        ...
                        <!-- Modal Edit gejala-->
                        <div class="modal fade" id="myModal<?php echo $data['id_petunjuk']; ?>" role="dialog">
                            ...
                            <!-- Modal content-->
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">Update Data Petunjuk</h4>
                                    </div>
                                    <div class="modal-body">
                                    <form role="form" action="edit-data-petunjuk.php" method="get">
                                       <?php
                                        $id_petunjuk = $data['id_petunjuk']; 
                                        $query_edit = mysqli_query($con, "SELECT * FROM petunjuk WHERE id_petunjuk='$id_petunjuk'");
                                        //$result = mysqli_query($conn, $query);
                                        while ($row = mysqli_fetch_array( $query_edit)) {  
                                       ?>
                                       <input type="hidden" name="id-petunjuk" value="<?php echo $row['id_petunjuk']; ?>">
                                        <div class="form-group">
                                            <label>Isi Petunjuk</label>
                                            <textarea name="isi-petunjuk" minlength="3" maxlength="1000" class="form-control" required><?php echo $row['isi_petunjuk']; ?></textarea>      
                                        </div>
