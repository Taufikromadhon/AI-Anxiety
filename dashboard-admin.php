                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="dashboard-admin.php">Profil Admin</a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h3 class="page-title pull-left">Dashboard Profil Admin</h3>
                ...
                <div class="col-12 mt-5">
                        <div class="card bg-primary">
                            <div class="card-body">
                                <div class="row">
                                    <div class="">
                                        <h4>Selamat datang <?php echo $_SESSION['admin-login']; ?>!</h4> 
                                        <br>
                                    <p></p>
                                    <p>Mari bekerja dengan sepenuh hati, untuk mengelola website AI Anxiety! Semangat!</p>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <h4>Data Admin Anda</h4>    
                                    </div>
                                    <div class="col-sm-6 text-right" style="align-content: right;" >
                                        <a href="ubah-password-admin.php">Ganti Password?</a>
                                    </div>
                                </div>
                            </div>
                                <div class="single-table">
                                    <div class="table-responsive">
                                        <table class="table table-hover progress-table text-center">
                                            ...
                                            <tbody>
                                                    <?php 
                                                    include 'koneksi.php';
                                                    $idadmin = $_SESSION['id-admin-login'];
                                                    $dataadmin = mysqli_query($con,"SELECT * FROM admin where id_admin='".$idadmin."'");
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <ul class="d-flex justify-content-center">
                                                                ...
                                                                <center>
                                                                    <li class="mr-3">
                                                                    <a href="#" class="open_modal" id='<?php echo  $data['id_admin'];?>' data-toggle="modal" data-target="#myModal<?php echo $data['id_admin']; ?>"
                        ...
                        <div class="modal fade" id="myModal<?php echo $data['id_admin']; ?>" role="dialog">
                            ...
                            <!-- Modal content-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="edit-data-admin.php" method="get">
                                       <?php
                                        $id_admin = $data['id_admin']; 
                                        $query_edit = mysqli_query($con, "SELECT * FROM admin WHERE id_admin='$id_admin'");
                                       ...
                                       <input type="hidden" name="id_admin" value="<?php echo $row['id_admin']; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="password" class="form-control" minlength="1" maxlength="10" value="<?php echo $row['password']; ?>"required>      
                                        </div>
                                        <div class="form-group">
                                            <label>Nama Lengkap</label>
                                            <input type="text" name="nama_lengkap" class="form-control" minlength="1" maxlength="30" value="<?php echo $row['nama_lengkap']; ?>" required>      
                                        </div>
                                        <div class="form-group">
                                            <label>Email</label>
                    ...
                    <!-- Progress Table inti data admin end -->
