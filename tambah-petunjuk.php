                            ...
                            <li>
                              ...
                              <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="tambah-petunjuk.php">Tambah Petunjuk</a></li>
                                </ul>
                            </li>
                              <li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h3 class="page-title pull-left">Tambah Petunjuk</h3>
              ...
              <div class="container" style="max-width: 80%;">
                 <!-- basic form start -->
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <form action="tambah-petunjuk-proses.php" method="POST">
                                            <div class="login-form-head">
                                                <h4>Tambah Petunjuk Umum</h4>
                                                <p>Isikan form berikut untuk menambahkan petunjuk tentang web AI Anxiety.</p><br>
                                            <div style="text-align: left;">
                                                <p>Panduan:</p><br>
                                                <p>

                                                    1. Isikan sesuai dengan peraturan ini.<br>
                                                    2. Buatlah petunjuk dengan bahasa yang baik dan mudah dipahami.<br>
                                                    3. Tidak perlu mencantumkan gambar, hanya saja gunakan kalimat yang mudah dicerna.<br>
                                                    4. Apapun petunjuk yang diberikan harus diperiksa kembali berulang kali.<br>
                                                </p>
                                            ...
                                            <div class="form-group">
                                                <label for="username">Id Petunjuk</label>
                                                <input type="text" class="form-control" placeholder="Masukan Id Gejala (misal 001)" name="id-petunjuk-baru" minlength="3" maxlength="3" required>
                                            </div>  
                                            <div class="form-group">
                                                <label for="namapakar">Isi Petunjuk</label>
                                                <textarea  placeholder="Masukan Isian Petunjuk"  class="form-control" name="isi-petunjuk-baru" minlength="1" maxlength="1000" required ></textarea>
                                            </div>
