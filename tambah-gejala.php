                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="tambah-gejala.php">Tambah Daftar Gejala</a></li>
                                </ul>
                            </li>
                            <li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h3 class="page-title pull-left">Tambah Gejala</h3>
              ...
              <div class="container" style="max-width: 80%;">
                 <!-- basic form start -->
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <form action="tambah-gejala-proses.php" method="POST">
                                            <div class="login-form-head">
                                                <h4>Tambah Jenis Gejala</h4>
                                                <p>Isikan form berikut untuk menambahkan jenis gejala.</p><br>
                                            <div style="text-align: left;">
                                                <p>Petunjuk:</p><br>
                                                <p>

                                                    1. Isikan sesuai dengan peraturan ini.<br>
                                                    2. Harus sesuai dengan standar acuan yang sudah teruji.<br>
                                                    3. ID gejala berada di range G01-G26.<br>
                                                    4. Penginputan ID tidak harus runtut, namun harus sesuai dan diperiksa kembali berulang kali.<br>
                                                </p>
                                            ...
                                            <div class="form-group">
                                                <label for="username">Id Gejala</label>
                                                <input type="text" class="form-control" placeholder="Masukan Id Gejala" name="id-gejala-baru" minlength="2" maxlength="3" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="namapakar">Nama Gejala</label>
                                                <input type="text" class="form-control" name="gejala-baru-nama-gejala" minlength="1" maxlength="100" placeholder="Masukan Nama Gejala" required >
                                            </div>
                                            <div class="form-group">
                                                <label for="username">Pertanyaan</label>
                                                 <textarea  placeholder="Masukan Pertanyaan Gejala"  class="form-control" name="gejala-baru-pertanyaan" minlength="1" maxlength="400"required ></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="namapakar">Keterangan Gejala</label>
                                                <textarea  placeholder="Masukan Keterangan Gejala"  class="form-control" name="gejala-baru-keterangan-gejala" minlength="1" maxlength="400" required ></textarea>
                                            </div>
