            ...
            <div class="login-box ptb--100">
                <form action="login-admin-proses.php" method="POST">
                    <div class="login-form-head">
                        <h4>Admin Sign In</h4>
                        <p>Mari Lakukan Sign In Dan Mulai Berkontribusi Untuk Web AI Anxiety</p>
                    </div>
                    <div class="login-form-body">
                        <div class="form-gp">
                            <label for="username">Username</label>
                            <input type="text" name="admin-username" id="username" min="1" maxlength="24" required>
                            <i class="ti-user"></i>
                        </div>
                        <div class="form-gp">
                            <label for="exampleInputPassword1">Password</label>
                            <input type="password" name="admin-password" id="pass" min="1" maxlength="10" required>
                            <i class="ti-lock"></i>
                        </div>
                        <div class="row mb-4 rmber-area">
                            ...
                            <div class="col-6 text-right">
                                <a href="admin-lupa-password.php">Lupa Password?</a>
                            </div>
                        </div>
