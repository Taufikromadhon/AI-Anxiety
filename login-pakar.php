    ...
    <div class="login-area">
        <div class="container">
            <div class="login-box ptb--100">
                <form action="login-pakar-proses.php" method="POST">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="form-gp">
                            ...
                            <input type="password" name="pakar-password" id="pass" min="1" maxlength="10" required>
                            <i class="ti-lock"></i>
                        </div>
                        <div class="row mb-4 rmber-area">
                            ...
                            <div class="col-6 text-right">
                                <a href="pakar-lupa-password.php">Lupa Password?</a>
                            </div>
                        </div>
