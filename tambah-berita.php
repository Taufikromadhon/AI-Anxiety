                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="tambah-berita.php">Tambah Berita</a></li>
                                </ul>
                            </li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h3 class="page-title pull-left">Tambah Berita</h3>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="">
                                        ...
                                        <br>
                                    <p></p>
                                    <p>Isikan berita terbaru untuk membantu perkembangan web AI Anxiety yuk!</p>
                                </div>
                            </div>
                                <div class="single-table">
                                    <div class="table-responsive">
                                        <table>
                                            <form action="tambah-berita-proses.php" method="post" enctype="multipart/form-data">
                                            <br>
                                            <br>
                                            <br>
                                            <div class="form-group">
                                                <label for="link-berita-baru">Link Berita</label>
                                                <input type="text" class="form-control" placeholder="Masukan Link Artikel Baru" name="link-berita-baru" minlength="1" maxlength="100" id="username" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="judul-berita-baru">Judul Berita</label>
                                                <input type="text" class="form-control" placeholder="Masukan Link Artikel Baru" name="judul-berita-baru" minlength="1" maxlength="100" id="username" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="tanggal-berita-baru">Tanggal Berita</label>
                                                <input type="date" class="form-control "   name="tanggal-berita-baru" id="username"  required>
                                            </div>
                                            <div class="form-group">
                                                <label for="status-berita-baru">Status Postingan Berita</label>
                                                <select class="form-control" name="status-berita-baru" style="font-size: 12px;" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" placeholder="Upload Gambar" name="gambar-berita-baru" id="gambar" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="isi-berita-baru">Isi Berita</label>
                                            </div>
                                            <div class="form-group">
                                                <textarea class="ckeditor" id="ckedtor" name="isi-berita-baru" required></textarea>
                                            </div>
