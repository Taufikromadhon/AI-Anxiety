...
<body>
    ...
    <div class="page-container">
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="lihat-gejala.php">Lihat Tabel Gejala</a></li>
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h3 class="page-title pull-left">Halaman Lihat Daftar Gejala</h3>
            ...
            <!-- page title area end -->
            <!-- Progress Table Inti Data gejala start -->
            <div class="container" style="max-width: 80%;">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <h4>Daftar Jenis Gejala AI Anxiety</h4>    
                                    </div>
                                    <div class="col-sm-6 text-right" style="align-content: right;" >
                                        <a href="tambah-gejala.php">+ Tambah Gejala</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover progress-table text-center">
                                            ...
                                            <tbody>
                                                    ...
                                                    include 'koneksi.php';
                                                    $no = 1;
                                                    $datagejala = mysqli_query($con,"select * from gejala");
                                                    while($data = mysqli_fetch_array($datagejala)){
                                                    ?>
                                                <tr>
                                                    <?php $no++; ?>
                                                    ...
                                                    <td><?php echo $data['keterangan_gejala']; ?></td>
                                                    
                                                        <td>
                                                        <ul class="d-flex justify-content-center">
                                                            <li class="mr-3">
                                                                <a href="#" class="open_modal" id='<?php echo  $data['id_gejala'];?>' data-toggle="modal" data-target="#myModal<?php echo $data['id_gejala']; ?>"
                                                                ><i class="fa fa-edit"></i></a></li>
                                                            
                                                            <li><a href="delete-data-gejala.php?id=<?php echo $data['id_gejala']; ?>" onclick="return confirm('Yakin Hapus?')" class="text-danger"><i class="ti-trash"></i></a></li>
                                                        </ul>
                                                        </td>
                    ...
                    <!-- Progress Table inti data gejala end -->
                     <!-- Cek cek -->


                    <?php 
                        $query = mysqli_query($con, "SELECT * FROM gejala");
                        $no = 1;
                        ...
                        <!-- Modal Edit gejala-->
                        <div class="modal fade" id="myModal<?php echo $data['id_gejala']; ?>" role="dialog">
                            ...
                            <!-- Modal content-->
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">Update Data Gejala</h4>
                                    </div>
                                    <div class="modal-body">
                                    <form role="form" action="edit-data-gejala.php" method="get">
                                       <?php
                                        $id_gejala = $data['id_gejala']; 
                                        $query_edit = mysqli_query($con, "SELECT * FROM gejala WHERE id_gejala='$id_gejala'");
                                       ...
                                       <input type="hidden" name="id_gejala" value="<?php echo $row['id_gejala']; ?>">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama_gejala" class="form-control" value="<?php echo $row['nama_gejala']; ?>"required>      
                                        </div>
                                        <div class="form-group">
                                            <label>Pertanyaan</label>
                                            <input type="text" name="pertanyaan" class="form-control" value="<?php echo $row['pertanyaan']; ?>" required>      
                                        </div>
                                        <div class="form-group">
                                            <label>Keterangan Gejala</label>
                                            <textarea name="keterangan_gejala" class="form-control" required><?php echo $row['keterangan_gejala']; ?></textarea>      
                                        </div>
