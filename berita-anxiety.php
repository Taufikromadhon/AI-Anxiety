        ...
        <div class="col-md-8">
          ...
          <!-- Blog Post -->
           ...
           <?php 
            ...
            $no = 0;
            $status="Active";
            $query = "SELECT * from berita WHERE status_postingan='$status'";
          ...
          ?>
           ...
           <div class="card mb-4">
            <a href="baca-berita-anxiety.php?judul=<?php  $id_pakar = $data['id_pakar']; 
                                                        ...
                                                        ?>" >
            <img class="card-img-top" src="filegambar/<?php echo $data['gambar'];?>" alt="Card image cap"></a>
            <div class="card-body">
              <h2 class="card-title"><a href="baca-berita-anxiety.php?judul=<?php  $id_pakar = $data['id_pakar']; 
                                                        $query_berita = mysqli_query($con, "SELECT * FROM berita WHERE id_berita='$no'");
                                                        //$result = mysqli_query($conn, $query);
                                                        while ($row = mysqli_fetch_array( $query_berita)) {   
                                                            echo $row['link_berita'] ; 
                                                        ...
                                                        ?>" ><?php echo $data['judul']; ?></a></h2>
              <p class="card-text"><?php echo substr($data['isi_berita'], 0, 350) ; ?>...</p>
              <a href="baca-berita-anxiety.php?judul=<?php  $id_pakar = $data['id_pakar']; 
                                                        $query_berita = mysqli_query($con, "SELECT * FROM berita WHERE id_berita='$no'");
                                                        //$result = mysqli_query($conn, $query);
                                                        while ($row = mysqli_fetch_array( $query_berita)) {   
            ...
            <div class="card-footer text-muted">
              Posted on <?php echo $data['tanggal_berita']; ?> by
              <a href="#"></a><?php  $id_pakar = $data['id_pakar']; 
