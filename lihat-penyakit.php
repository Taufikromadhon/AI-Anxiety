...
<body>
    ...
    <div class="page-container">
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li  class="active"><a href="lihat-penyakit.php">Lihat Tabel Penyakit</a></li>
        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h3 class="page-title pull-left">Halaman Lihat Daftar Penyakit</h3>
            ...
            <!-- page title area end -->
            <!-- Progress Table Inti Data penyakit start -->
            <div class="container" style="max-width: 80%;">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <h4>Daftar Jenis Penyakit AI Anxiety</h4>    
                                    </div>
                                    <div class="col-sm-6 text-right" style="align-content: right;" >
                                        <a href="tambah-penyakit.php">+ Tambah Jenis Penyakit</a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table class="table table-hover progress-table text-center">
                                            <thead class="text-uppercase">
                                                <tr>
                                                    ...
                                                    <th scope="col">Definisi Dan Solusi</th>  
                                            ...
                                            <tbody>
                                                    ...
                                                    include 'koneksi.php';
                                                    $no = 1;
                                                    $datapenyakit = mysqli_query($con,"select * from penyakit");
                                                    while($data = mysqli_fetch_array($datapenyakit)){
                                                    ?>
                                                <tr>
                                                    <?php $no++; ?>
                                                    <td><?php echo $data['id_penyakit']; ?></td>
                                                    <td><?php echo $data['nama_penyakit']; ?></td> 
                                                    <td style="width="60px";><?php echo substr($data['definisi_solusi'], 0, 350) ; ?>...</td> 
                                                    <td>
                                                        <ul class="d-flex justify-content-center">
                                                            <li class="mr-3">
                                                                <a href="#" class="open_modal" id='<?php echo  $data['id_penyakit'];?>' data-toggle="modal" data-target="#myModal<?php echo $data['id_penyakit']; ?>"
                                                                ><i class="fa fa-edit"></i></a></li>
                                                            
                                                            <li><a href="delete-data-penyakit.php?id=<?php echo $data['id_penyakit']; ?>" onclick="return confirm('Yakin Hapus?')" class="text-danger"><i class="ti-trash"></i></a></li>
                                                        </ul>
                                                    </td>
                                                </tr>
                    ...
                    <?php 
                        $query = mysqli_query($con, "SELECT * FROM penyakit");
                        $no = 1;
                        ...
                        <!-- Modal Edit penyakit-->
                        <div class="modal fade" id="myModal<?php echo $data['id_penyakit']; ?>" role="dialog">
                            ...
                            <!-- Modal content-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="edit-data-penyakit.php" method="get">
                                       <?php
                                        $id_penyakit = $data['id_penyakit']; 
                                        $query_edit = mysqli_query($con, "SELECT * FROM penyakit WHERE id_penyakit='$id_penyakit'");
                                       ...
                                       <input type="hidden" name="id_penyakit" value="<?php echo $row['id_penyakit']; ?>">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama_penyakit" class="form-control" value="<?php echo $row['nama_penyakit']; ?>"required>      
                                        </div>
                                        <div class="form-group">
                                            <label>Definisi Solusi</label>
                                             <textarea class="ckeditor" id="ckedtor" name="definisi-solusi" required><?php echo $row['definisi_solusi']; ?></textarea>     
                                        </div>
